...
var base_role = [
	...
	},
	{
		...
		"crit":22,
		"mdef":0,
		"info":"武士为强攻型职业，注重速度与暴击，但是防御较为薄弱。\n职业特性：暴击伤害提高35%，速度收益提高6%，受到的伤害增加10%，每次升级额外额外获得15点速度与暴击"
	},
	{
		"name":"致命拳手",
		"lv":1,
		...
		"crit":10,
		"mdef":2,
		"info":"拳手为攻防一体型职业，速度力量防御三维全面发展。\n职业特性：自带2%的额外物免与魔免，每次升级额外提高16点生命值、6点攻击力、6点速度"
	},
	{
		"name":"战地牧师",
		"lv":1,
